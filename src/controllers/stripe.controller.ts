 ...
 */
 public getPrices: RequestHandler = async (req, res, next) => {
 ...
 */
 public createCheckoutSession: RequestHandler = async (req, res, next) => {
 ...
 */
 private async handleOrderPayment(
  ...
  logger.info(`Order ${orderId} paid successfully via Stripe`);
 }
